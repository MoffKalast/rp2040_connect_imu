...
Firmward and ROS Noetic driver for the RP2040 Connect board with an onboard IMU. It does onboard fusion with arbitrary precision floats for high numerical stability.
